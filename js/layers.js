    ...
    upgrades: {
        ...
        23: {
            ...
            effect() {
                ...
                // Apply diminishing factor only if points exceed the threshold
                if (player.ct.points.gte(new Decimal(1e50))) {
                    diminishingFactor = player.ct.points.div(1e50).pow(0.03125); // Slight division factor
                }
            return base.div(diminishingFactor); // Apply the diminishing factor
        },
            effectDisplay() { 
        ...
        31: {
            ...
            effect() {
                ...
                // Apply diminishing factor only if points exceed the threshold
                if (player.ct.points.gte(new Decimal(1e50))) {
                    diminishingFactor = player.ct.points.div(1e50).pow(0.0375); // Slight division factor
                }
            return base.div(diminishingFactor); // Apply the diminishing factor
        },
            effectDisplay() { 
