...
addLayer("infi", {
    ...
    buyables: {
        11: {
            ...
            cost(x) { return new Decimal(10).times(new Decimal(15).add(x).div(8).pow(x)); },  // The cost formula
        ...
        12: {
            ...
            cost(x) { return new Decimal(100).times(new Decimal(15).add(x).div(8).pow(x)); },  // The cost formula
