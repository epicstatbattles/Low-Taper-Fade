...
addLayer("infi", {
    ...
    buyables: {
        11: {
            ...
            cost(x) { return new Decimal(10).times(new Decimal(15).div(8).add(x).pow(x)); },  // The cost formula
        ...
        12: {
            ...
            cost(x) { return new Decimal(100).times(new Decimal(15).div(8).add(x).pow(x)); },  // The cost formula
